...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function openModal() {
    ...
    document.body.style.overflow = 'hidden'; //если пользователь сам перешел в модальное окно 
  ...
  function getStaticInformation(parentSelector, activeClass) {
    ...
    var elements = document.querySelectorAll("".concat(parentSelector, " div")); //В данном случае делегирование событий не применимо
